...
export function apiAuthRefreshTokenPost$Plain(http: HttpClient, rootUrl: string, params?: ApiAuthRefreshTokenPost$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseDto>> {
